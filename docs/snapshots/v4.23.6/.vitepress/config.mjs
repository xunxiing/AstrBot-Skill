    ...
    root: {
      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          {
            text: "Skill 开发",
            base: "/design_standards",
            collapsed: true,
            items: [
              { text: "核心概念", link: "/core_concepts" },
              { text: "架构总览", link: "/architecture_overview" },
              { text: "最佳实践", link: "/best_practices" },
              { text: "上下文使用", link: "/context_usage" },
              { text: "事件流", link: "/event_flow" },
              { text: "沙盒", link: "/sandbox" },
              { text: "视觉工具", link: "/visual_utils" },
            ],
          },
          {
            text: "Agent",
            ...
            items: [
              ...
              { text: "对话", link: "/conversation" },
              { text: "上下文压缩", link: "/context-compression" },
              { text: "定时任务", link: "/cron" },
              { text: "调用 LLM", link: "/Invoke-llm" },
              { text: "人格解析", link: "/persona-resolution" },
              { text: "人格集合", link: "/persona-sets" },
              { text: "沙盒", link: "/sandbox" },
              { text: "子智能体", link: "/subagents" },
              { text: "Agent 相关钩子", link: "/agent-related-hooks" },
              { text: "官方工具列表", link: "/offical-tool-list/tools" },
            ],
          },
          {
            text: "消息",
          ...
          {
            text: "平台适配器",
            base: "/platform_adapters",
            collapsed: true,
            items: [
              { text: "适配器接口", link: "/adapter_interface" },
              { text: "消息转换", link: "/message_conversion" },
              { text: "Telegram 媒体组", link: "/telegram_media_group" },
            ],
          },
          {
            text: "插件配置",
            ...
            collapsed: true,
            items: [
              { text: "命令管理", link: "/command_management" },
              { text: "装饰器", link: "/decorators" },
              { text: "文件配置", link: "/file_config" },
              { text: "钩子", link: "/hooks" },
              { text: "生命周期", link: "/lifecycle" },
              { text: "Schema", link: "/schema" },
              { text: "会话控制", link: "/session_control" },
            ],
          },
          {
            text: "存储与工具",
            ...
            collapsed: true,
            items: [
              { text: "文件存储", link: "/file_storage" },
              { text: "KV 存储", link: "/kv_storage" },
              { text: "文转图", link: "/text_to_image" },
            ],
          },
          {
            text: "部署",
      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "Core Concepts", link: "/core_concepts" },
              { text: "Architecture Overview", link: "/architecture_overview" },
              { text: "Best Practices", link: "/best_practices" },
              { text: "Context Usage", link: "/context_usage" },
              { text: "Event Flow", link: "/event_flow" },
              { text: "Sandbox", link: "/sandbox" },
              { text: "Visual Utils", link: "/visual_utils" },
            ],
          },
          {
            text: "Agent",
            ...
            collapsed: true,
            items: [
              { text: "Agent Overview", link: "/" },
              { text: "Agent Runner", link: "/agent-runner" },
              { text: "Conversation", link: "/conversation" },
              { text: "Context Compression", link: "/context-compression" },
              { text: "Cron", link: "/cron" },
              { text: "Invoke LLM", link: "/Invoke-llm" },
              { text: "Persona Resolution", link: "/persona-resolution" },
              { text: "Persona Sets", link: "/persona-sets" },
              { text: "Sandbox", link: "/sandbox" },
              { text: "Subagents", link: "/subagents" },
              { text: "Agent Related Hooks", link: "/agent-related-hooks" },
              { text: "Official Tool List", link: "/offical-tool-list/tools" },
            ],
          },
          {
            text: "Messages",
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "Adapter Interface", link: "/adapter_interface" },
              { text: "Message Conversion", link: "/message_conversion" },
              { text: "Telegram Media Group", link: "/telegram_media_group" },
            ],
          },
          {
            text: "Plugin Config",
            ...
            collapsed: true,
            items: [
              { text: "Command Management", link: "/command_management" },
              { text: "Decorators", link: "/decorators" },
              { text: "File Config", link: "/file_config" },
              { text: "Hooks", link: "/hooks" },
              { text: "Lifecycle", link: "/lifecycle" },
              { text: "Schema", link: "/schema" },
              { text: "Session Control", link: "/session_control" },
            ],
          },
          {
            text: "Storage & Utils",
            ...
            collapsed: true,
            items: [
              { text: "File Storage", link: "/file_storage" },
              { text: "KV Storage", link: "/kv_storage" },
              { text: "Text to Image", link: "/text_to_image" },
            ],
          },
          {
            text: "Deployment",
